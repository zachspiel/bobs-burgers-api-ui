      ...
      <div className="d-flex">
        ...
        <div className="main-content">
          <div className="bg-light p-5 text-center">
            ...
            <p className="lead">
              Get all data for Bob's Burgers from a single API.
            </p>
          </div>
          <div className="row justify-content-center mt-5">
            <div className="col-md-7 col-sm-12">
              ...
              <b>What is this?</b>
              <p>
                The Bob's Burgers API is a programatically accessable data
                source for Bob's Burgers. The data is formatted in JSON and can
              ...
              <div className="info-box">
                ...
                <div className="">
                  <p>
                    ...
                    to make an API request for the first character "Dottie
                    Minerva".
                  </p>
                </div>
              </div>
          ...
          <div className="row justify-content-center mt-5">
            <div className="col-md-7 col-sm-12">
              ...
              <Divider />
              The base URL is the root URL for the entire API. If a request
              returns a 404 response, check this URL first.
